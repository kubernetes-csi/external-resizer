...
replace k8s.io/endpointslice => k8s.io/endpointslice v0.37.1
...
replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.37.1

replace k8s.io/sample-controller => k8s.io/sample-controller v0.37.1
