...
- Move RecoverVolumeExpansionFailure feature-gate to GA (#577, @gnufied). This was feature was already GAed in Kubernetes v1.34, so this change in feature-gate of external-resizer is merely ceremonial.
